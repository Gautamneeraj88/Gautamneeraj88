...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Open%20To%20Work-00ffc8?style=for-the-badge&logo=checkmarx&logoColor=0d1117" />
</p>
...
![SSE](https://img.shields.io/badge/Server--Sent%20Events-00ffc8?style=for-the-badge&logo=socketdotio&logoColor=black)
...
## 🏗️ Architecture I've Worked With
...
```bash
$ neofetch --config neeraj

OS:       macOS (MacBook Air M4) + Raspberry Pi 5 (Kali Linux)
Shell:    zsh
Editor:   Neovim (50+ plugins, custom config — see nvim-config repo)
Terminal: iTerm2 / Alacritty
Notes:    Samsung Tab S6 Lite (handwritten, Cornell system)
Workflow: Terminal-first. Mouse optional.
```

[![nvim config](https://img.shields.io/badge/My%20Neovim%20Config-57A143?style=for-the-badge&logo=neovim&logoColor=white)](https://github.com/Gautamneeraj88/nvim-config)
